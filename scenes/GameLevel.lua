...
GameLevel.new          = function()
    ...
    local backgroundMusic  = SoundEffect.new("background", "assets/music/map-" .. configuration:getLevel() .. ".mp3", "stream", true, true, configuration:getMusicVolume())
    local victorySound     = SoundEffect.new("victorySound", "assets/sound/victory.mp3", "static", false, false, configuration:getSoundVolume())
    local defeatSound      = SoundEffect.new("defeatSound", "assets/sound/defeat.mp3", "static", false, false, configuration:getSoundVolume())
