...
LevelSelect.new = function()
    ...
    local level1 =
        LevelButton.new(
        "LevelSelect_level1",
        "assets/levelselect/map-1.png",
        "assets/levelselect/map-1-disabled.png",
        "assets/levelselect/map-1-hover.png",
        "assets/levelselect/map-1-locked.png",
        223 - 32,
        543 - 32,
        1,
        function(data)
            levelSelect.onLevelClick(data)
        end,
        function(data)
            levelSelect.onLevelEnter(data)
        end,
        function(data)
            levelSelect.onLevelLeave(data)
        end
    )
    local level2 =
        LevelButton.new(
        "LevelSelect_level2",
        "assets/levelselect/map-2.png",
        "assets/levelselect/map-2-disabled.png",
        "assets/levelselect/map-2-hover.png",
        "assets/levelselect/map-2-locked.png",
        671 - 32,
        351 - 32,
        2,
        function(data)
    ...
    local level3 =
        LevelButton.new(
        "LevelSelect_level3",
        "assets/levelselect/map-3.png",
        "assets/levelselect/map-3-disabled.png",
        "assets/levelselect/map-3-hover.png",
        "assets/levelselect/map-3-locked.png",
        1120 - 32,
        159 - 32,
        3,
        function(data)
    ...
    local returnButton =
        Button.new(
        "LevelSelect_returnButton",
        "assets/ui/yellow_button00.png",
        "assets/ui/yellow_button04.png",
        "assets/ui/yellow_button03.png",
        screenManager:getWindowWidth() - 220,
        screenManager:getWindowHeight() - 72,
        "Menu Principal",
        function()
