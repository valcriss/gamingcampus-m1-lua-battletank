...
MainMenuFrame.new = function(name, title, x, y, width, height, action)
    ...
    local frameTitle           = BitmapText.new(mainMenuFrame.name .. "_frameTitle", "assets/fonts/ui-18.fnt", title, "center", "center", mainMenuFrame.bounds.x + (mainMenuFrame.bounds.width / 2) + 7, mainMenuFrame.bounds.y - 13)
