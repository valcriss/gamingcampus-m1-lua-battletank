...
ParametersFrame.new = function(name, title, x, y, width, height, moveSpeed, action)
    ...
    local confirmButton      = Button.new("confirmButton", "assets/ui/green_button00.png", "assets/ui/green_button04.png", "assets/ui/green_button03.png", parametersFrame.bounds.x + 40, parametersFrame.bounds.y + parametersFrame.bounds.height - 60, "Sauvegarder", function()
        ...
        parametersFrame.data.action({ fullScreen = fullScreenCheckbox.isChecked(), vsync = vsyncCheckbox.isChecked(), musicVolume = musicSlider.getValue(), soundVolume = soundSlider.getValue(), difficulty = difficultySlider.getValue(), maximized = love.window.isMaximized(), level = configuration:getLevel(), })
    end)
    local cancelButton       = Button.new("confirmButton", "assets/ui/red_button11.png", "assets/ui/red_button01.png", "assets/ui/red_button02.png", parametersFrame.bounds.x + parametersFrame.bounds.width - 180, parametersFrame.bounds.y + parametersFrame.bounds.height - 60, "Annuler", function() parametersFrame.data.action() end)
