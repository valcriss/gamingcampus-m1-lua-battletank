...
LevelButton.new   = function(name, enableAssetPath, disableAssetPath, hoverAssetPath, lockedAssetPath, finishedAssetPath, x, y, level, onclick, onEnter, onLeave)
    ...
    local soundEffect     = SoundEffect.new(levelButton.name .. "_soundEffect", "assets/sound/switch2.mp3", "static", false, false, configuration:getSoundVolume())
    local forbiddenEffect = SoundEffect.new(levelButton.name .. "_forbiddenEffect", "assets/sound/wrong.mp3", "static", false, false, configuration:getSoundVolume())
